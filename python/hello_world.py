...
furhat = FurhatClient("127.0.0.1") # Also provide authentication key here if needed
...
furhat.request_voice_config(name="neural", gender="male", language="en-US") 
...
user_data = furhat.request_users()
